...
namespace taskangular.Server.Models;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AdminId).HasName("PK__Admin__43AA41418CF71068");
        ...
        {
            entity.HasKey(e => e.CartItemId).HasName("PK__Cart_Ite__5D9A6C6E945FF994");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__D54EE9B4BF0C9FF2");
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("PK__Comment__E79576876ADBF88F");
        ...
        {
            entity.HasKey(e => e.ContactId).HasName("PK__Contact__024E7A8699A300FC");
        ...
        {
            entity.HasKey(e => e.CoponId).HasName("PK__Copons__8A47306FF7D203C5");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__46596229BBBDC78B");
        ...
        {
            entity.HasKey(e => e.OrderItemId).HasName("PK__Order_It__3764B6BC0CF549B7");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payments__ED1FC9EA5259A0E8");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__47027DF5259C0567");
        ...
        {
            entity.HasKey(e => e.ServiceId).HasName("PK__Service__4550733F66D05435");
        ...
        {
            entity.HasKey(e => e.SubServiceId).HasName("PK__subServi__C5C51FFA7179416F");
